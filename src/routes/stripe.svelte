...
<div class="flex flex-col max-w-6xl mb-16 w-full mx-auto">
    ...
    <div class="flex flex-col px-6 md:px-12 xl:px-6">
        <div class="flex flex-col space-y-2">
            ...
            <p class="font-sans text-gray-700 text-2xl">Explore our guides and examples to integrate Stripe.</p>
        </div>
        <div class="flex flex-row border-b items-center justify-between mt-6">
            <div class="flex flex-col space-y-4 pr-5 pb-16 md:mb-4">
                <p class="font-sans font-bold text-gray-800 text-2xl">Payments</p>
                <p class="font-sans text-gray-700 text-xl">Build a web or mobile integration to accept payments online or in person.</p>
                <button class="inline-flex justify-center items-center w-28 bg-indigo-500 rounded px-2 py-1.5">
                    <span class="font-sans text-sm font-medium text-white whitespace-nowrap text-center">Get started</span>
                    <svg class="w-3 h-3 ml-2 text-white fill-current" aria-hidden="true" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.583 7L7.992 2.409A1 1 0 1 1 9.407.993l6.3 6.3a1 1 0 0 1 0 1.414l-6.3 6.3a1 1 0 0 1-1.415-1.416L12.583 9H1a1 1 0 1 1 0-2z" fill-rule="evenodd"></path>
                    </svg>
                </button>
                <div class="hidden lg:flex flex-row space-x-2 pt-2">
                    <p class="font-sans bg-gray-200 text-gray-600 font-medium border px-2 cursor-pointer rounded text-xs">Online</p>
                    <p class="font-sans bg-gray-200 text-gray-600 font-medium border px-2 cursor-pointer rounded text-xs">In person</p>
                    <p class="font-sans bg-gray-200 text-gray-600 font-medium border px-2 cursor-pointer rounded text-xs">Subscriptions</p>
                    <p class="font-sans bg-gray-200 text-gray-600 font-medium border px-2 cursor-pointer rounded text-xs">Marketplaces</p>
                </div>
            </div>
            <div class="hidden md:flex">
                <img class="max-w-lg" src="https://b.stripecdn.com/docs/assets/618a02ec341526208c1ce462d6e4e941.svg" alt="" >
            </div>
        </div>
        <div class="hidden md:flex flex-row justify-between mx-auto space-x-24 w-full h-full mt-6 relative">
           <StripeImageItem titleText={"Business operations"} titleDetailText={"Programmatically or manually monitor, protect, and report on the money you make with Stripe."} firstSectionItemText={"Prevent and handle disputes"} secondSectionItemText={"Generate reports"} imgSrc={"https://b.stripecdn.com/docs/assets/351f994957bbce29d4e0509e06d076d4.svg"} />
           <StripeImageItem titleText={"Financial services"} titleDetailText={"Move, control, and borrow money with Stripe's APIs and financial services."} firstSectionItemText={"Issue cards instantly"} secondSectionItemText={"Learn about the Stripe Corporate Card"} imgSrc={"https://b.stripecdn.com/docs/assets/b28276daa215c700dd56ddac319eed5f.svg"} />
        ...
        <div class="hidden md:flex flex-col mt-10 space-y-4">
            <p class="font-sans font-bold text-gray-800 text-xl mt-8">Explore using Stripe</p>
            <div class="grid grid-cols-3 gap-8 pt-6">
                ...
                <StripeExploreItem type={"security"} exploreItemTitle={"Security"} exploreItemDetailText={"Strengthen your integration security and learn about sensitive data."} />
                <StripeExploreItem type={"account"} exploreItemTitle={"Account"} exploreItemDetailText={"Activate, manage, and configure your account."} />
            </div>
        </div>
    </div>
    <div class="flex flex-col mt-16 pb-24 px-6 md:px-12 xl:px-6">
        <p class="font-sans font-bold text-gray-800 text-xl pt-8">Explore Stripe products </p>
        <div class="flex flex-col sm:flex-row mt-8">
            <div class="flex flex-col py-8 w-full sm:w-1/2 space-y-6">
                <div class="flex flex-col space-y-6">
                    <p class="font-sans font-semibold text-gray-800">Direct payments</p>
                ...
                <div class="flex flex-col space-y-6">
                    <p class="font-sans font-semibold text-gray-800">Multiparty payments</p>
                    <StripeProductItem type={"connect"} productitemTitle={"Connect"} productitemDetail={"Payments for platforms and marketplaces"} />
                </div>
                <div class="flex flex-col space-y-6">
                    <p class="font-sans font-semibold text-gray-800">Prebuilt components</p>
            ...
            <div class="flex flex-col py-8 px-0 sm:px-12 w-full sm:w-1/2 bg-white md:bg-gray-100 rounded space-y-6">
                <div class="flex flex-col space-y-6">
                    <p class="font-sans font-semibold text-gray-800">Business operations</p>
                ...
                <div class="flex flex-col space-y-6">
                    <p class="font-sans font-semibold text-gray-800">Financial services</p>
    ...
    <div class="flex flex-col sm:flex-row border-t py-6 px-6 md:px-12 xl:px-6">
        <div class="flex flex-col w-full sm:w-1/2 space-y-3">
            <div class="flex flex-row space-x-3 items-center">
                ...
                <div class="flex flex-row space-x-1">
                    <p class="font-sans font-medium text-sm text-gray-700">Questions?</p>
                    <p class="font-sans text-sm text-indigo-500 font-medium hover:text-gray-800 whitespace-nowrap cursor-pointer">Contact Us</p>
                </div>
            </div>
            <div class="flex flex-row space-x-3 items-center">
                <svg class="w-4 h-4 text-gray-600 fill-current" aria-hidden="true" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-row space-x-1">
                    <p class="font-sans font-medium text-sm text-gray-700">Developer tutorials on</p>
                    <p class="font-sans text-sm text-indigo-500 font-medium hover:text-gray-800 whitespace-nowrap cursor-pointer">Youtube</p>
                </div>
            </div>
        ...
        <div class="flex flex-col w-full sm:w-1/2 space-y-2 mt-6">
            <p class="font-sans text-sm text-gray-700 font-medium">Sign up for developer updates:</p>
            ...
            <p class="font-sans text-xs">You can unsubscribe at any time. Read our<span class="cursor-pointer ml-1 text-indigo-500 font-medium hover:text-gray-800">privacy policy</span></p>
        </div>
    </div>
</div>
